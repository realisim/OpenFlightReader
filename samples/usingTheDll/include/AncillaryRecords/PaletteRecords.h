...
{
    //-------------------------------------------------------------------------
    class OFR_API ColorPaletteRecord : public AncillaryRecord
    {
    public:
    ...
    //-------------------------------------------------------------------------
    class OFR_API LightSourcePaletteRecord : public AncillaryRecord
    {
    public:
    ...
    //-------------------------------------------------------------------------
    class OFR_API MaterialPaletteRecord : public AncillaryRecord
    {
    public:
    ...
    //-------------------------------------------------------------------------
    class OFR_API VertexPaletteRecord : public AncillaryRecord
    {
    public:
